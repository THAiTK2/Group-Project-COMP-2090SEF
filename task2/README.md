...
## Video introduction
[click this to watch the video in Google Drive ]([https://drive.google.com/file/d/1hCcJaOjyVVENd5tyBkIiokf_sdta4hkn/view?usp=drive_link](https://drive.google.com/drive/folders/1AobwiWPJpvqmKytiDaQRUfuDMgFu2hHb?usp=sharing))
...
This prints a 2D matrix  list, converting  each number to a string and joins them with spaces.


<br><p><img src="/assert/image/A. matrix _3.png" height="1500" width="1000"></p>
Initialization: V = 4 creates a 4*4 matrix filled with zeros ,representing 4 vertices (labeled 0, 1, 2, and 3) with no connections.
...
<br>The output will like this:
<p><img src="/assert/image/result.png" height="500" width="500"></p> 
