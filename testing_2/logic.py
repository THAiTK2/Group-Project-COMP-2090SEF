...
class TeamManagementSystem:
    ...
    def __init__(self, db_path=None, auto_import_json=True, default_json_path=None):
        ...
        # Sync SQL data into domain objects.
        self._refresh_state()
    ...
    def add_student(
        ...
        # Build domain object first to enforce model-level validation (GPA/attendance).
        ...
        if username and password:
            # Optional account creation for direct login.
            self.create_account(
                username=username,
                password=password,
                role="student",
    ...
    def create_account(
        ...
        # Normalize username/role for consistent lookup and permission check.
    ...
    def create_team(
        ...
        # Persist only primitive values in SQL; OOP object stays in memory cache.
    ...
    def assign_student_to_team(self, student_id, team_name):
        ...
        # Validate eligibility through domain object so rule is not bypassed by UI/SQL.
    ...
    def list_team_performance(self):
        # Build readable report lines for CLI/student dashboard.
        self._refresh_state()
        lines = []
    ...
    def save_to_json(self, file_path):
        # Legacy export helper kept for compatibility/demo backup.
        self._refresh_state()
        payload = {
            "students": [
                {
    ...
    def _refresh_state(self):
        ...
        # This keeps GUI/business logic consistent with latest persisted state.
        self.students = {}
        self.coaches = {}
        self.teachers = {}
        self.teams = {}
