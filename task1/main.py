...
class LoginFrame(ctk.CTkFrame):
    ...
    def _login(self):
        ...
        try:
            ...
            # take user to dashboard based on role
...
class StaffDashboardFrame(ctk.CTkFrame):
    ...
    def _build_add_tab(self):
        ...
        self.stu_user = self._labeled_entry(student_box, "Username (required)")
        self.stu_pass = self._labeled_entry(student_box, "Password (required)", show="*")
        ...
        hint_text = (
            ...
            "- Student/Coach account is required\n"
    ...
    def _add_student(self):
        ...
        def action():
            self.app.system.add_student(
                ...
                username=self.stu_user.get().strip(),
                password=self.stu_pass.get().strip(),
            )
