...
class StaffDashboardFrame(ctk.CTkFrame):
    ...
    def _build_update_tab(self):
        ...
        delete_student_box.grid(row=1, column=0, padx=8, pady=8, sticky="nsew")
        ctk.CTkLabel(
            delete_student_box,
            text="Delete Student",
        ...
        delete_coach_box.grid(row=1, column=1, padx=8, pady=8, sticky="nsew")
        ctk.CTkLabel(
            delete_coach_box,
            text="Delete Coach",
            font=ctk.CTkFont(weight="bold"),
        ...
        delete_teacher_box.grid(row=1, column=2, padx=8, pady=8, sticky="nsew")
        ctk.CTkLabel(
            delete_teacher_box,
            text="Delete Teacher",
            font=ctk.CTkFont(weight="bold"),
        ...
        delete_team_box.grid(row=2, column=0, padx=8, pady=8, sticky="nsew")
        ctk.CTkLabel(
            delete_team_box,
            text="Delete Team",
            font=ctk.CTkFont(weight="bold"),
        ...
        delete_competition_box.grid(row=2, column=1, padx=8, pady=8, sticky="nsew")
        ctk.CTkLabel(
