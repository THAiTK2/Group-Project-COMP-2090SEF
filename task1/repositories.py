...
class TeamManagementRepository:
    ...
    def update_teacher(self, member_id, name=None, department=None):
        row = self.get_teacher(member_id)
        if row is None:
        ...
        self._execute(
            ...
            WHERE member_id = ?
            """,
            (updated_name, updated_department, member_id),
        )
    ...
    def update_competition_record_content(
        self,
        record_id,
        year,
        month,
