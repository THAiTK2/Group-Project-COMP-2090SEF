...
# this abstract class defines common fields and methods for all people in the system.
...
# SportTeam is abstract and defines behavior contract for all sport
...
class FootballTeam(SportTeam):
    ...
    def calculate_performance(self):
        # composite score is used for demonstration and reporting in this project
        return (
...
# Account model 
# UserAccount represents login identity used in authentication and authorization
class UserAccount:
